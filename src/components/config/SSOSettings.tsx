...
export function SSOSettings() {
  ...
  return (
    <div className="grid grid-cols-1 items-stretch gap-6 lg:grid-cols-2">
      ...
      {/* SSO Providers */}
      <div className="flex flex-col overflow-hidden rounded-xl border border-border bg-card">
        {/* py-3 rather than py-4: the h-8 button makes this row 56px tall,
            matching the Sign-in Methods header so both dividers line up. */}
        <div className="flex items-center justify-between gap-3 px-6 py-3">
          <div className="flex items-center gap-3">
            <ShieldCheck className="h-5 w-5 text-muted-foreground" />
            <h3 className="text-base font-semibold">Identity Providers</h3>
          </div>
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="space-y-2">
                        <div className="flex items-start gap-2 text-sm">
                          <span className="w-24 shrink-0 font-medium text-foreground">Issuer:</span>
                        ...
                        {provider.oidcConfig && (
                          <>
                            <div className="flex items-start gap-2 text-sm">
                              <span className="w-24 shrink-0 font-medium text-foreground">Client ID:</span>
                            ...
                            {provider.oidcConfig.scopes && provider.oidcConfig.scopes.length > 0 && (
                              <div className="flex items-start gap-2 text-sm">
                                <span className="w-24 shrink-0 font-medium text-foreground">Scopes:</span>
                        ...
                        {provider.samlConfig && (
                          <div className="flex items-start gap-2 text-sm">
                            <span className="w-24 shrink-0 font-medium text-foreground">Entry Point:</span>
                        ...
                        {provider.organizationId && (
                          <div className="flex items-start gap-2 text-sm">
                            <span className="w-24 shrink-0 font-medium text-foreground">Organization:</span>
